...
export const PRESETS: FilterPreset[] = [
  {
    ...
    emoji: "🌤",
    filters: [
      { variable: "temperature_day", stat: "median", operator: "between", value: 14, value2: 30 },
      { variable: "temperature_day", stat: "p90", operator: "<", value: 32 },
      { variable: "temperature_day", stat: "p10", operator: ">", value: 5 },
      { variable: "temperature_night", stat: "median", operator: "between", value: 8, value2: 26 },
      { variable: "temperature_night", stat: "p90", operator: "<", value: 26 },
      { variable: "dew_point", stat: "mean", operator: ">", value: 0 },
      { variable: "rainy_days", stat: "median", operator: "<", value: 0.15 },
  ...
  },
  {
    ...
    emoji: "🏖",
    filters: [
      { variable: "temperature_day", stat: "median", operator: ">", value: 26 },
      { variable: "temperature_day", stat: "p90", operator: "<", value: 40 },
      { variable: "dew_point", stat: "mean", operator: "between", value: 12, value2: 20 },
      { variable: "rainy_days", stat: "median", operator: "<", value: 0.10 },
  ...
  },
  {
    ...
    emoji: "🥾",
    filters: [
      { variable: "temperature_day", stat: "median", operator: "between", value: 13, value2: 27 },
      { variable: "temperature_day", stat: "p90", operator: "<", value: 33 },
  ...
  },
  {
    ...
    emoji: "💻",
    filters: [
      { variable: "temperature_day", stat: "median", operator: "between", value: 18, value2: 32 },
      { variable: "temperature_day", stat: "p90", operator: "<", value: 36 },
      { variable: "dew_point", stat: "p90", operator: "<", value: 20 },
      { variable: "rainy_days", stat: "median", operator: "<", value: 0.12 },
    ],
  },
  {
    id: "dry-sunny",
  ...
  },
  {
    ...
    filters: [
      { variable: "temperature_day", stat: "median", operator: "between", value: 14, value2: 30 },
      { variable: "temperature_day", stat: "p90", operator: "<", value: 35 },
      { variable: "temperature_day", stat: "p10", operator: ">", value: 5 },
      { variable: "temperature_night", stat: "median", operator: "between", value: 8, value2: 26 },
      { variable: "temperature_night", stat: "p90", operator: "<", value: 26 },
      { variable: "rainy_days", stat: "median", operator: "<", value: 0.20 },
