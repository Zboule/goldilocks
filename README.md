...
gh release download v2.1.0 --repo Zboule/goldilocks --pattern "tiles-*.tar.gz" --dir /tmp
tar -xzf /tmp/tiles-v2.1.0.tar.gz -C data/
...
```bash
tar -czf tiles-v2.1.0.tar.gz -C data tiles/
gh release create v2.1.0 tiles-v2.1.0.tar.gz --repo Zboule/goldilocks \
  --title "v2.1.0 – 0.25° 36-period uint16 tiles" \
